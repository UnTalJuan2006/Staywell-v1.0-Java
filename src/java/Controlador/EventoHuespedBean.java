...
//            precioDia = BigDecimal.ZERO;
//            FacesContext.getCurrentInstance().addMessage(null,
//                    new FacesMessage(FacesMessage.SEVERITY_ERROR, "Error de datos",
//                            "No se pudo obtener información del espacio: " + ex.getMessage()));
//            System.err.println("Error actualizarPrecioPorEspacio(): " + ex.getMessage());
//        }
//    }
//
...
//        } catch (SQLException e) {
//            context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Error",
//                    "No se pudo cargar la información del espacio: " + e.getMessage()));
//            System.err.println("Error buscar espacio en confirmarEvento(): " + e.getMessage());
//            return null;
//        }
//
